...
○ Wrapper 클래스
1. 
자바에서는 언어 수준에서 제공하는 기본형 데이터를 제외한 
...
:일반적으로 레퍼런스 형과 기본 자료형은 호환되지 않으며
  ...
  ob = a;
  //-- 기본 자료형(int)이 Integer 형으로 '자동' 변환(a를 오토 박싱)
  ...
  // ★ 오른쪽부터 처리한다!!!!
   ...
   이는 JDK 1.5 이후 추가된 오토 박싱/오토 언박싱 이라는 기능으로 인해 가능해진 것이다.
...
public class day23 {
	...
	public static void main(String[] args)
	{
		...
		b = c.intValue();  // 그냥 언박싱, 직접 풀어서 반환해준 것이므로...

		d = new Object();
		System.out.println("d.toString() : " + d.toString());
		//--> d.toString() : java.lang.Object@7852e922

		d = new Integer(10);  //--업 캐스팅   //d 는 오브젝트 타입
		System.out.println("d.toString() :" + d.toString());
		//--> d.toString() :10
