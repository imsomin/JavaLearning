...
//두 인터페이스(ADemo2, BDemo2)를 상속받은 인터페이스
...
//abstract class DemoTest implements CDemo
//    ↓
//두 인터페이스(ADemo, BDemo)를 상속받은 인터페이스를 구현한 후
//모든 메소드를 재정의한 클래스
class DemoTest4 implements CDemo
{
	@Override
	public void test()
	{
...
public class day20_3 {
	...
	{
		//두 인터페이스를 상속받은 인터페이스를 구현한 추상 클래스에 대한
		//모든 메소드를 재정의한 클래스에 대한 인스턴스 생성
		DemoTest4 ob6 = new DemoTest4();
